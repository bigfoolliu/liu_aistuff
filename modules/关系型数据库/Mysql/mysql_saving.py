...
2. 连接数据库
当前的MySQL运行在本地，用户名为tonyliu，密码为liu941103，运行端口为3306。
...
data_base = pymysql.connect(host='localhost', user='tonyliu', password='liu941103', port=3306)
...
# import pymysql
# # 建立连接
# db = pymysql.connect(host='localhost', user='tonyliu', password='liu941103', port=3306, db='spiders')
# # 获得操作光标
# cursor = db.cursor()
