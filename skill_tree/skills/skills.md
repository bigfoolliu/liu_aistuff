...
<!-- TOC -->autoauto- [effiency提高效率的小技巧](#effiency提高效率的小技巧)auto    - [1.为命令设置别名(alias)](#1为命令设置别名alias)auto    - [2.dotfiles快速将恢复自身配置](#2dotfiles快速将恢复自身配置)auto    - [3.项目里重复的工作写成makefile](#3项目里重复的工作写成makefile)auto    - [4.快速为项目选择一个source license](#4快速为项目选择一个source-license)auto    - [5.量化工作](#5量化工作)auto    - [6.会话以及终端管理tmux](#6会话以及终端管理tmux)auto    - [7.windows虚拟桌面(workspace)](#7windows虚拟桌面workspace)auto    - [8.必读书籍](#8必读书籍)auto    - [9.开发者工具](#9开发者工具)auto    - [10.chrome高效使用](#10chrome高效使用)auto    - [11.ssh免密以及别名登录](#11ssh免密以及别名登录)auto    - [13.HTTP Api设计指南](#13http-api设计指南)auto    - [8.a修改windows开机启动自动执行脚本](#8a修改windows开机启动自动执行脚本)autoauto<!-- /TOC -->
...
- 设置`vim .bashrc`,然后`source .bashrc`使之生效
