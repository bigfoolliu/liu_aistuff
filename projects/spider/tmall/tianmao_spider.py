...
class taobao_infos(object):
    ...
    def __init__(self):
        ...
        self.wait = WebDriverWait(self.browser, 20)  # 超时时长为20s
    ...
    def crawl_good_data(self, keyword="羽毛球"):
        """爬取天猫商品数据"""

        # 对天猫商品数据进行爬虫
        self.browser.get("https://list.tmall.com/search_product.htm?q={}".format(keyword))
        ...
        for page in range(2,int(page_total)):
            ...
            WebDriverWait(self.browser, 10, 1).until(EC.presence_of_element_located((By.ID, "nc_1_n1z")))  # 等待滑动拖动控件出现
            try:
...
if __name__ == "__main__":
    ...
    chromedriver_path = "C:\\Users\\tonyl\\Desktop\\chromedriver_win32\\chromedriver.exe"  # 改成你的chromedriver的完整路径地址
